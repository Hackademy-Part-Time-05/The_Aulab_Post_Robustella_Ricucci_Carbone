...
Route::get('/article/writer/{user}', [ArticleController::class, 'byUser'])->name('article.byUser');
Route::get('/user/{user}/profile', [PublicController::class, 'profile'])->name('user.profile');
